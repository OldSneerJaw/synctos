  ...
  function validateDoc(doc, oldDoc, docDefinition, docType) {
    ...
    function validateDocContents() {
      ...
      var attachmentModule =
        importSyncFunctionFragment('attachment-module.js')(utils, buildItemPath, resolveItemConstraint);
      ...
      // The following functions are nested within this function so they can share access to the doc, oldDoc,
      // validationErrors and itemStack variables from the surrounding context
      ...
      function resolveItemConstraint(constraintDefinition) {
        if (typeof constraintDefinition === 'function') {
          ...
          return constraintDefinition(doc, utils.resolveOldDoc(), currentItemEntry.itemValue, currentItemEntry.oldItemValue);
        } else {
